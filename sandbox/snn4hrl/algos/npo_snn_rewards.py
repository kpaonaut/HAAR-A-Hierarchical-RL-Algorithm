...
# from sandbox.snn4hrl.algos.logger_ten import Logger2 as Logger_ten
# import time
...
class BatchSampler_snn(BatchSampler):
    ...
    def __init__(self,
        ...
        # now = time.strftime("%b-%d_%H:%M:%S")  # create unique directories
        # logger.log(now)
        # self.logger_tb = Logger_ten('/home/lsy/logs/SNN_Swimmer/%s/' % (now))
        # self.episode = 0

        # file = '/home/lsy/Desktop/params.pkl'
        # data = joblib.load(file)
        # self.source_policy = data['policy']
        # print("policy", self.source_policy)
        # print("already load policy")
