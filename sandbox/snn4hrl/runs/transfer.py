"""
Transfer trained policy to a new environment
"""
...
import configs.config_for_transfer as par # import parameters
...
for maze_size_scaling in [4]:
    ...
    for time_step_agg in [10]:
        ...
        for s in [20, 10, 30, 40, 0]:  # range(10, 110, 10):  # [10, 20, 30, 40, 50]:
            exp_prefix = par.exp_prefix_set
            now = datetime.datetime.now(dateutil.tz.tzlocal())
            timestamp = now.strftime('%Y_%m_%d_%H_%M_%S')

            exp_name = '{}TransferBoth_{}TansferLow_{}mazeid_{}anneal_{}parallel_{}LowStepNum_{}MaxLowStep_{}timestepagg_{}'.format(
                par.transfer_high,
                par.transfer_low,
                int(par.maze_id),
